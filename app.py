...
def precipitation():
    """
        Query for the dates and temperature observations within a year range.
        Convert the query results to a Dictionary using date as the key and tobs as the value.
        Return the JSON representation of your dictionary.
        
        Important Notes: Instead of tobs, perform the query for prcp as the route states "precipitation".
                        Return list of dictionaries.
                        Add the station id.
    """
    # Call the date_calc function to get the start & end date of the previous year
    Range = date_calc()
    End_date = Range[1]
    Start_date = Range[0]
    # Query for the dates and temperature observations from the year range.
